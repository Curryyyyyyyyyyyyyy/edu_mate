...
const COURSES: Record<string, StudentCourseDetail> = {
  course_001: {
    ...
    name: "操作系统",
    description:
      "本课程介绍操作系统的核心原理，包括进程管理、内存管理和文件系统。",
    teacher_name: "李老师",
    semester: "2026春季",
    status: "active",
    section_count: 3,
...
const store = {
    ...
    course_001: [
      {
        ...
        order: 1,
        material_url: "/files/section_001_slides.pdf",
        assignment_count: 2,
        submitted_count: 1,
        section_score: 88,
      },
      ...
      },
      {
        id: "section_003",
        title: "第三章：文件系统",
        description: "介绍文件系统结构、目录和存储管理。",
        order: 3,
        material_url: "/files/section_003_notes.docx",
        assignment_count: 1,
        submitted_count: 0,
        section_score: null,
      },
    ...
    course_002: [
      {
        id: "section_004",
        title: "第一章：线性表",
        description: "顺序表、链表及其操作。",
        order: 1,
        material_url: "/files/section_004_textbook.pdf",
        assignment_count: 2,
        submitted_count: 2,
        section_score: 95,
      },
      ...
      assignments: [
        {
          id: "asg_006",
          title: "文件系统练习",
          due_at: "2026-06-25T23:59:00+08:00",
          status: "open" as const,
          submitted: false,
          score: null,
        },
    ...
    section_004: {
      ...
      assignments: [
        ...
        },
        {
          id: "asg_005",
          title: "顺序表与链表对比",
          due_at: "2026-06-22T23:59:00+08:00",
          status: "open" as const,
          submitted: true,
          score: 95,
        },
  ...
  assignments: {
    course_001: [
      ...
      },
      {
        ...
        section_title: "第一章：进程管理",
        title: "调度算法分析",
        description: "对比FCFS、SJF和时间片轮转算法，不少于 300 字。",
        due_at: "2026-06-20T23:59:00+08:00",
        full_score: 100,
        status: "open" as const,
        attachment_url: null,
    ...
    course_002: [
      {
        ...
        section_title: "第一章：线性表",
        title: "链表反转练习",
        description: "实现单链表反转并分析时间复杂度。",
        due_at: "2026-06-18T23:59:00+08:00",
        full_score: 100,
        status: "open" as const,
        attachment_url: null,
  ...
  submissions: {} as Record<
    string,
    {
      id: string;
      assignment_id: string;
      submit_type: "text" | "file";
      content: string;
      file_ids?: string[];
      submitted_at: string;
      score: number | null;
...
store.learningPlans["course_001"] = [
  {
    ...
    plan: [
      {
        day: 1,
        task: "精读课件「进程状态转换图」，重点理解阻塞态与挂起态的区别",
        duration_minutes: 60,
        section_id: "section_001",
        section_title: "第一章：进程管理",
      },
...
store.planProgress["plan_001"] = {
  ...
  tasks: [
    ...
    },
    {
      ...
      completed: true,
      feedback: "算法对比还需要再复习",
      completed_at: "2026-06-12T20:00:00+08:00",
    },
    {
      day: 3,
      task: "完成进程调度相关习题5道",
...
store.announcements["course_001"] = [
  ...
  },
  {
    ...
    title: "关于实验课安排调整",
    content:
      "原定于本周五的实验课因故调整至下周一（6 月 16 日）下午 2:00，地点不变（机房 401）。\n\n实验内容：进程调度算法模拟实现\n\n请提前预习实验指导书第三章内容。",
    is_pinned: false,
    created_at: "2026-06-07T16:30:00+08:00",
  },
];

// 讨论
const studentAuthor: DiscussionAuthor = {
  id: STUDENT.id,
  name: STUDENT.name,
  role: "student",
};
const teacherAuthor: DiscussionAuthor = {
  id: TEACHER.id,
  name: TEACHER.name,
  role: "teacher",
};
...
store.discussions["course_001"] = [
  {
    ...
    title: "进程和线程的区别到底是什么？",
    content:
      "我在看课件的时候对进程和线程的区别还是有些模糊。课件里说进程是资源分配的基本单位，线程是CPU调度的基本单位。但在实际编程中怎么体现这个区别呢？有没有同学可以帮忙解释一下？",
    status: "open",
    reply_count: 3,
    created_by: { ...studentAuthor },
    last_reply_at: "2026-06-11T10:30:00+08:00",
      ...
      items: [
        {
          id: "reply_001",
          content:
            "简单来说，进程之间是独立的，每个进程有自己的内存空间；而同一进程内的线程共享内存空间。所以线程间通信更方便，但一个线程崩溃可能影响整个进程。",
          author: { id: "user_s2", name: "李四", role: "student" },
          is_teacher: false,
        ...
        },
        {
          id: "reply_002",
          content:
            "李四同学说得很好。补充一点：在实际编程中，比如用 Python 的 multiprocessing 模块创建的是进程，它们各自有独立的 Python 解释器；而 threading 模块创建的是线程，共享全局变量。这也是为什么 Python 有 GIL 限制但多进程不受影响。",
        ...
        },
        {
          id: "reply_003",
          content:
            "谢谢老师和同学的解释，现在清楚多了！那请问有没有推荐的练习可以帮助理解？",
  ...
  },
  {
    ...
    section_id: "section_002",
    section_title: "第二章：内存管理",
    title: "分页和分段在实际系统中怎么用的？",
    content:
      "课件里介绍了分页和分段两种内存管理方式，但我想知道现代操作系统（比如 Linux）实际用的是哪种？还是混合使用？",
    status: "open",
    reply_count: 1,
    created_by: { id: "user_s2", name: "李四", role: "student" },
    last_reply_at: "2026-06-11T09:00:00+08:00",
      ...
      items: [
        {
          id: "reply_004",
          content:
            "Linux 主要使用分页机制，但也支持分段。实际上 x86 架构同时支持分段和分页，但 Linux 尽量弱化了分段的使用，主要通过分页来管理内存。可以查阅《深入理解 Linux 内核》相关章节了解更多。",
          author: { ...teacherAuthor },
          is_teacher: true,
...
store.quizzes["course_001"] = [
  {
    ...
    course_id: "course_001",
    title: "进程管理基础测验",
    description: "测试对进程概念、状态转换和调度算法的理解",
    section_id: "section_001",
    ...
    questions: [
      ...
      },
      {
        ...
        content:
          "在时间片轮转调度算法中，时间片设置得越小，系统响应时间一定越快。",
        options: [
          { key: "true", text: "正确" },
          { key: "false", text: "错误" },
        ],
  ...
  },
  {
    ...
    course_id: "course_001",
    title: "内存管理综合测验",
    description: "考察内存分页、分段和虚拟内存的综合理解",
    section_id: "section_002",
    ...
    questions: [
      ...
      },
      {
        ...
        question_type: "short_answer",
        content:
          "请简述 LRU（最近最久未使用）页面置换算法的基本思想及其优缺点。",
        score: 20,
        order: 3,
      },
    ] as StudentQuizQuestion[],
  ...
  result: {
    ...
    results: [
      ...
      },
      {
        ...
        ai_feedback: "回答正确！",
        correct_answer: "C",
        explanation: "进程因等待 I/O 操作等事件而进入阻塞状态。",
      },
      {
        question_id: "qzq_003",
        is_correct: true,
        ...
        explanation: "时间片过小会导致上下文切换开销过大，反而降低系统效率。",
      },
      {
        question_id: "qzq_004",
        is_correct: false,
        score: 5,
        ai_feedback: "部分正确，内存使用率不属于调度算法评价指标。",
        correct_answer: "A,B,C,D",
        explanation:
          "CPU利用率、吞吐量、周转时间、等待时间是调度算法的四个主要评价指标。",
      },
      {
        question_id: "qzq_005",
        is_correct: true,
        score: 10,
        ai_feedback: "回答正确，四个必要条件表述完整。",
        correct_answer: "互斥条件、占有且等待、不可剥夺、循环等待",
        explanation:
          "死锁的四个必要条件缺一不可，破坏其中任一条件即可预防死锁。",
      },
    ],
  },
};
  ...
  records: [
    {
      ...
      teacher_comment: "整体答得不错，扣分项需要认真复习课本相关内容。",
      graded_at: "2026-06-09T10:00:00+08:00",
    },
    {
      assignment_id: "asg_005",
      assignment_title: "链表反转练习",
      section_title: "第一章：线性表",
      full_score: 100,
      score: 95,
      ai_score: 95,
      ...
      graded_at: "2026-06-10T14:00:00+08:00",
    },
  ] as ScoreRecord[],
};
...
export function mockHandle(
  ...
  // ── 小节 ──────────────────────────────────────────────
  const sectionDetailMatch = path.match(
    /^\/api\/student\/courses\/([^/]+)\/sections\/([^/]+)$/,
  );
  ...
  // ── 聊天 ──────────────────────────────────────────────
  const chatSessionsMatch = path.match(
    /^\/api\/student\/courses\/([^/]+)\/chat\/sessions\/([^/]+)\/messages$/,
  );
  if (method === "GET" && chatSessionsMatch) {
    return handleGetSessionMessages(chatSessionsMatch[1], chatSessionsMatch[2]);
  }
  const chatSessionsListMatch = path.match(
    /^\/api\/student\/courses\/([^/]+)\/chat\/sessions$/,
  );
  ...
  // ── 总结 ──────────────────────────────────────────────
  const sumDetailMatch = path.match(
    /^\/api\/student\/courses\/([^/]+)\/summaries\/([^/]+)$/,
  );
  ...
  // ── 学习计划 ──────────────────────────────────────────
  const planProgressMatch = path.match(
    /^\/api\/student\/courses\/([^/]+)\/learning-plans\/([^/]+)\/progress$/,
  );
  ...
  const planStatusMatch = path.match(
    /^\/api\/student\/courses\/([^/]+)\/learning-plans\/([^/]+)\/status$/,
  );
  ...
  // ── 公告（学生端）────────────────────────────────────
  const noticeDetailMatch = path.match(
  ...
  const noticeListMatch = path.match(
    /^\/api\/courses\/([^/]+)\/announcements$/,
  );
  ...
  // ── 讨论（学生端）────────────────────────────────────
  const discReplyMatch = path.match(
    /^\/api\/courses\/([^/]+)\/discussions\/([^/]+)\/replies\/([^/]+)$/,
  );
  if (method === "DELETE" && discReplyMatch) {
    return handleDeleteDiscussionReply(
      discReplyMatch[1],
      discReplyMatch[2],
      discReplyMatch[3],
    );
  }
  const discReplyCreateMatch = path.match(
    /^\/api\/courses\/([^/]+)\/discussions\/([^/]+)\/replies$/,
  );
  if (method === "POST" && discReplyCreateMatch) {
    return handleCreateDiscussionReply(
      discReplyCreateMatch[1],
      discReplyCreateMatch[2],
      data,
    );
  }
  const discDetailMatch = path.match(
  ...
  // ── 测验（学生端）────────────────────────────────────
  const quizResultMatch = path.match(
    /^\/api\/student\/courses\/([^/]+)\/quizzes\/([^/]+)\/attempts\/([^/]+)\/result$/,
  );
  if (method === "GET" && quizResultMatch) {
    return handleGetQuizResult(
      quizResultMatch[1],
      quizResultMatch[2],
      quizResultMatch[3],
    );
  }
  const quizSubmitMatch = path.match(
    /^\/api\/student\/courses\/([^/]+)\/quizzes\/([^/]+)\/attempts\/([^/]+)\/submit$/,
  );
  ...
  // 学生管理
  const tStudentsMatch = path.match(
  ...
  const tRemoveStudentMatch = path.match(
    /^\/api\/teacher\/courses\/([^/]+)\/students\/([^/]+)$/,
  );
  if (method === "DELETE" && tRemoveStudentMatch) {
    return handleTeacherRemoveStudent(
      tRemoveStudentMatch[1],
      tRemoveStudentMatch[2],
    );
  }
  // 小节
  const tSectionsListMatch = path.match(
    /^\/api\/teacher\/courses\/([^/]+)\/sections$/,
  );
  ...
  const tSectionPatchMatch = path.match(
    /^\/api\/teacher\/courses\/([^/]+)\/sections\/([^/]+)$/,
  );
  if (method === "PATCH" && tSectionPatchMatch) {
    return handleTeacherUpdateSection(
      tSectionPatchMatch[1],
      tSectionPatchMatch[2],
      data,
    );
  }
  if (method === "DELETE" && tSectionPatchMatch) {
    return handleTeacherDeleteSection(
      tSectionPatchMatch[1],
      tSectionPatchMatch[2],
    );
  }
  // 发布作业（在小节下）
  const tPublishAsgMatch = path.match(
    /^\/api\/teacher\/courses\/([^/]+)\/sections\/([^/]+)\/assignments$/,
  );
  if (method === "POST" && tPublishAsgMatch) {
    return handleTeacherPublishAssignment(
      tPublishAsgMatch[1],
      tPublishAsgMatch[2],
      data,
    );
  ...
  const tGradingReportMatch = path.match(
    /^\/api\/teacher\/courses\/([^/]+)\/assignments\/([^/]+)\/grading-report$/,
  );
  if (method === "GET" && tGradingReportMatch) {
    return handleTeacherGradingReport(
      tGradingReportMatch[1],
      tGradingReportMatch[2],
    );
  }
  // 查重
  const tAnalyzeMatch = path.match(
    /^\/api\/teacher\/courses\/([^/]+)\/assignments\/([^/]+)\/analyze$/,
  );
  if (method === "POST" && tAnalyzeMatch) {
    return handleTeacherAnalyze(tAnalyzeMatch[1], tAnalyzeMatch[2], data);
  }
  const tAnalyzeReportMatch = path.match(
    /^\/api\/teacher\/courses\/([^/]+)\/assignments\/([^/]+)\/analyze-report$/,
  );
  if (method === "GET" && tAnalyzeReportMatch) {
    return handleTeacherAnalyzeReport(
      tAnalyzeReportMatch[1],
      tAnalyzeReportMatch[2],
    );
  }
...
async function handleLogin(body: {
  ...
  if (body.username === STUDENT.username && body.password === "123456") {
    return {
      success: true,
      data: { token: MOCK_TOKEN, expires_in: 86400, user: STUDENT },
      message: "ok",
    };
  }
  if (body.username === TEACHER.username && body.password === "123456") {
    return {
      success: true,
      data: { token: MOCK_TOKEN, expires_in: 86400, user: TEACHER },
      message: "ok",
    };
  }
...
async function handleGetCourses(): Promise<
  ApiResponse<{ items: StudentCourseItem[]; total: number }>
> {
  await delay();
...
async function handleJoinCourse(body: {
  code: string;
  ...
  throw {
    response: { status: 404, data: { detail: "课程码无效或课程不存在" } },
  };
}
...
async function handleGetSections(
  ...
  ApiResponse<{ course_id: string; items: SectionItem[]; total: number }>
> {
  await delay();
  const items = store.sections[courseId] || [];
  return {
    success: true,
    data: { course_id: courseId, items, total: items.length },
    message: "ok",
  };
}
...
async function handleGetSectionDetail(
  ...
  if (!detail || detail.course_id !== courseId)
...
async function handleSendMessage(
  ...
  return {
    ...
    data: {
      ...
      rag_used: true,
      references:
        session.messages[session.messages.length - 1].references || [],
      suggestions,
    },
    message: "ok",
  };
...
async function handleGetChatSessions(
  ...
  ApiResponse<{ course_id: string; items: ChatSessionItem[]; total: number }>
> {
  await delay();
...
async function handleGetSessionMessages(
  ...
  return {
    success: true,
    data: { session_id: sessionId, course_id: courseId, messages },
    message: "ok",
  };
}

async function handleGetAssignments(courseId: string): Promise<
  ApiResponse<{
    course_id: string;
...
async function handleSubmitAssignment(
  ...
  if (data instanceof FormData) {
    ...
    submitType =
      typeField === "file" || typeField === "mixed" || typeField === "text"
        ? typeField
        : "text";
    ...
    // 优先读取 file_ids 字段（新 API 两步流程：先上传再提交）
    const fileIdsField = fd.get("file_ids") as string | null;
    if (fileIdsField) {
      fileUrls = fileIdsField
        .split(",")
        .map((u) => u.trim())
        .filter(Boolean);
    }
    ...
    if (!fileUrls || fileUrls.length === 0) {
      ...
      if (allFiles.length > 0) {
        ...
        if (!content) {
          content = allFiles
            .map(
              (f) => `[文件上传] ${f.name} (${(f.size / 1024).toFixed(1)} KB)`,
            )
            .join("\n");
        }
      }
...
async function handleGetMySubmission(
  _courseId: string,
  asgId: string,
  ...
  if (!sub)
    return {
      success: true,
      data: null as unknown as MySubmissionData,
      message: "ok",
    };
  return {
    success: true,
    data: {
      ...
      file_url: sub.file_ids?.[0] ?? null,
      file_urls: sub.file_ids,
      content: sub.content,
      submitted_at: sub.submitted_at,
      status: "submitted",
      score: sub.score,
...
async function handleCreateSummary(
  ...
  const item: SummaryDetail = {
    ...
    title: body.title,
    rag_used: !body.source_text,
    references: body.source_text
      ? []
      : [
          {
            section_id: "section_001",
...
async function handleGetSummaries(
  ...
  ApiResponse<{ course_id: string; items: SummaryListItem[]; total: number }>
> {
  await delay();
  const items: SummaryListItem[] = (store.summaries[courseId] || []).map(
    (s) => ({
      id: s.id,
...
async function handleDeleteSummary(
  ...
  if (store.summaries[courseId]) {
    store.summaries[courseId] = store.summaries[courseId].filter(
      (s) => s.id !== summaryId,
    );
  }
...
async function handleCreateLearningPlan(
  ...
  const days = (body.plan_days as number) || 7;
  const plan: LearningPlanData = {
    ...
    plan: Array.from({ length: days }, (_, i) => ({
      day: i + 1,
      task: [
        `复习${course?.name || "课程"}第${i + 1}章核心知识点`,
        `完成相关练习题 ${Math.floor(mins / 10)} 道`,
        "整理错题笔记并总结解题方法",
        "进行单元小测检验学习效果",
        "回顾本周学习内容并查漏补缺",
        "专项训练薄弱知识点",
...
async function handleGetLearningPlans(courseId: string): Promise<
  ApiResponse<{
    course_id: string;
...
> {
  await delay();
  const items: LearningPlanListItem[] = (
    store.learningPlans[courseId] || []
  ).map((p) => ({
    id: p.id,
...
async function handleGetLearningPlan(
  ...
  if (!p) {
    ...
    const pre = (store.learningPlans["course_001"] || []).find(
      (x) => x.id === planId,
    );
...
async function handleUpdatePlanStatus(
  ...
  return {
    success: true,
    data: { id: planId, status: (data as Record<string, string>).status },
    message: "updated",
  };
}
...
async function handleMarkTaskComplete(
  ...
  progress.completion_rate =
    progress.total_days > 0 ? progress.completed_days / progress.total_days : 0;
...
async function handleGetPlanProgress(
  _courseId: string,
  planId: string,
...
async function handleGetDiscussions(
  ...
  await delay();
  const items: DiscussionItem[] = (store.discussions[courseId] || []).map(
    (d) => ({
      id: d.id,
...
async function handleGetDiscussion(
  courseId: string,
  discussionId: string,
...
async function handleCreateDiscussionReply(
  courseId: string,
  discussionId: string,
  data: unknown,
...
async function handleDeleteDiscussionReply(
  courseId: string,
  discussionId: string,
  replyId: string,
): Promise<ApiResponse<{ id: string }>> {
...
async function handleGetStudentQuizzes(
  courseId: string,
...
async function handleGetStudentQuiz(
  courseId: string,
  quizId: string,
...
async function handleStartQuiz(
  ...
  return {
    success: true,
    data: { attempt_id: attemptId, started_at: new Date().toISOString() },
    message: "started",
  };
}
...
async function handleSubmitQuiz(
  ...
  const results: QuizAnswerResult[] = q.questions.map((question) => {
    const userAnswer =
      body.answers.find((a) => a.question_id === question.id)?.answer || "";
    // 简单判断对错（mock 用包含判断）
    const correctAnswer =
      (question as unknown as { correct_answer?: string }).correct_answer || "";
    let isCorrect = false;
  ...
  if (store.quizAttempts[attemptKey]) {
    ...
    store.quizAttempts[attemptKey].answers = Object.fromEntries(
...
async function handleGetQuizResult(
  courseId: string,
  quizId: string,
  _attemptId: string,
): Promise<ApiResponse<QuizResultData>> {
...
async function handleGetStudentCourseScores(
  courseId: string,
  ...
  if (!data) {
    ...
    return {
      ...
      data: {
        course_id: courseId,
        course_name: COURSES[courseId]?.name || "",
        total_score: 0,
        rank: 0,
        total_students: 0,
        records: [],
...
const TEACHER_COURSES_STORE: Record<
  string,
  {
    id: string;
    name: string;
    ...
    students: [
      {
        ...
        name: STUDENT.name,
        class_name: STUDENT.extra.class_name || "",
      ...
      },
      {
        ...
        name: "李四",
        class_name: "计算机2401班",
        joined_at: "2026-06-04T11:00:00+08:00",
        total_score: 92,
      },
      {
        id: "user_s3",
        ...
        name: "王五",
        class_name: "计算机2401班",
        joined_at: "2026-06-04T11:30:00+08:00",
        total_score: 78,
      },
    ],
  },
...
async function handleTeacherGetCourses(): Promise<
  ApiResponse<{
    items: {
      id: string;
      name: string;
...
async function handleTeacherCreateCourse(
  data: unknown,
): Promise<ApiResponse<unknown>> {
  await delay(400);
  const body = data as Record<string, string>;
  ...
  const course = {
    ...
    code: "CS" + Math.random().toString(36).slice(2, 6).toUpperCase(),
...
async function handleTeacherGetCourseDetail(
  courseId: string,
): Promise<ApiResponse<unknown>> {
  await delay();
...
async function handleTeacherGetStudents(
  courseId: string,
): Promise<ApiResponse<unknown>> {
  await delay();
  const c = TEACHER_COURSES_STORE[courseId];
  ...
  return {
    success: true,
    data: { course_id: courseId, items: c.students, total: c.students.length },
    message: "ok",
  };
}

async function handleTeacherAddStudents(
  courseId: string,
  data: unknown,
): Promise<ApiResponse<unknown>> {
  await delay();
  ...
  return {
    success: true,
    data: { course_id: courseId, added, failed },
    message: "ok",
  };
}

async function handleTeacherRemoveStudent(
  courseId: string,
  studentId: string,
): Promise<ApiResponse<unknown>> {
  await delay();
...
async function handleTeacherGetSections(
  courseId: string,
): Promise<ApiResponse<unknown>> {
  await delay();
  const items = store.sections[courseId] || [];
...
async function handleTeacherCreateSection(
  courseId: string,
  data: unknown,
): Promise<ApiResponse<unknown>> {
  await delay();
  const fd = data as FormData;
  const materialFileId = fd.get("material_file_id")
    ? String(fd.get("material_file_id"))
    : null;
  // 如果上传了课件文件，生成模拟 material_url
  const materialUrl = materialFileId
    ? `/files/section_material_${materialFileId}.pdf`
    : null;
...
async function handleTeacherUpdateSection(
  courseId: string,
  sectionId: string,
  data: unknown,
): Promise<ApiResponse<unknown>> {
  await delay();
  const body = data as Record<string, string>;
  const sections = store.sections[courseId];
  if (!sections) throw { response: { status: 404 } };
  const section = sections.find((s) => s.id === sectionId);
  if (!section) throw { response: { status: 404 } };

  if (body.title) section.title = body.title;
  if (body.description !== undefined) section.description = body.description || undefined;
  if (body.order !== undefined) section.order = Number(body.order) || 0;
...
async function handleTeacherDeleteSection(
  courseId: string,
  sectionId: string,
): Promise<ApiResponse<unknown>> {
  await delay();
  if (store.sections[courseId]) {
    store.sections[courseId] = store.sections[courseId].filter(
      (s) => s.id !== sectionId,
    );
  }
...
async function handleTeacherPublishAssignment(
  courseId: string,
  sectionId: string,
  data: unknown,
): Promise<ApiResponse<unknown>> {
  ...
  const section = (store.sections[courseId] || []).find(
    (s) => s.id === sectionId,
  );
  const asg = {
    id: asgId,
    ...
    full_score: Number(fd.get("full_score")) || 100,
    status: "open" as const,
    attachment_url: null,
  };
  ...
  return {
    success: true,
    data: { ...asg, created_at: new Date().toISOString() },
    message: "published",
  };
}

async function handleTeacherGetAssignments(
  courseId: string,
): Promise<ApiResponse<unknown>> {
  await delay();
  const list = store.assignments[courseId] || [];
...
async function handleTeacherGetAssignmentDetail(
  courseId: string,
  asgId: string,
): Promise<ApiResponse<unknown>> {
  await delay();
  ...
  return {
    ...
    data: {
      ...
      description: a.description,
      reference_answer:
        "参考答案：进程状态转换的关键在于理解就绪、运行、阻塞三种状态之间的转换条件...",
...
async function handleTeacherCloseAssignment(
  _courseId: string,
  asgId: string,
): Promise<ApiResponse<unknown>> {
  await delay();
  return {
    success: true,
    data: { id: asgId, status: "closed" },
    message: "closed",
  };
}

async function handleTeacherGetSubmissions(
  _courseId: string,
  asgId: string,
): Promise<ApiResponse<unknown>> {
  await delay();
  // 生成模拟提交 - 混合文本和文件类型
  const students = TEACHER_COURSES_STORE["course_001"]?.students || [];
  const items = students.map((s, index) => {
    const base = {
      id: uid("submission"),
      student_id: s.id,
      student_name: s.name,
    ...
    if (index === 0) {
      ...
      return {
        ...base,
        submit_type: "file" as const,
        content: null,
        extracted_text:
          "实验一：进程同步实验报告\n\n一、实验目的\n1. 理解进程同步的基本概念\n2. 掌握信号量机制的使用方法\n3. 实现经典进程同步问题的解决方案\n\n二、实验内容\n1. 生产者-消费者问题：创建5个生产者进程和3个消费者进程，通过信号量实现缓冲区的互斥访问。\n2. 读者-写者问题：实现读者优先策略，测试多读者并发访问的性能。\n\n三、实验结果\n生产者-消费者问题在缓冲区大小为10时运行稳定，无死锁现象。读者-写者问题中读者并发数达到20时性能下降明显。",
        file_url: "/api/uploads/mock/作业_进程同步实验报告.pdf",
        file_urls: [
          "/api/uploads/mock/作业_进程同步实验报告.pdf",
          "/api/uploads/mock/附件_测试数据.docx",
        ],
      };
    } else if (index === 1) {
      // 混合提交：文件 + 文本
      return {
        ...base,
        submit_type: "file" as const,
        content: "这是对文件内容的补充说明，具体实现见附件。",
        file_url: "/api/uploads/mock/算法设计文档.docx",
        file_urls: ["/api/uploads/mock/算法设计文档.docx"],
      };
    }
    // 文本提交（保持原有逻辑）
    return {
      ...
      content:
        "本次作业围绕核心概念进行分析，结合课堂案例说明关键状态之间的转换条件，并给出自己的理解。",
      file_url: null,
    };
  });
  return {
    success: true,
    data: { assignment_id: asgId, items, total: items.length },
    message: "ok",
  };
}
...
async function handleTeacherGrade(
  ...
  return {
    success: true,
    data: { assignment_id: asgId, results },
    message: "graded",
  };
}

async function handleTeacherConfirmGrade(
  _courseId: string,
  _asgId: string,
  submissionId: string,
  data: unknown,
...
async function handleTeacherGradingReport(
  _courseId: string,
  asgId: string,
): Promise<ApiResponse<unknown>> {
  await delay();
...
async function handleTeacherAnalyze(
  _courseId: string,
  asgId: string,
  data: unknown,
): Promise<ApiResponse<unknown>> {
  ...
  const dims = body.compare_dimensions || [
    "structure",
    "concept",
    "expression",
    "conclusion",
  ];
  const submissions = body.submission_ids.map((sid, i) => ({
    submission_id: sid,
    student_name: ["张三", "李四", "王五"][i % 3],
  }));
      ...
      ? [
          {
            ...
            ai_reason: "两份作业在观点顺序、关键句表达和例子选择上高度相似",
          },
        ]
      : [];
  const comparisonDetails = submissions.map((s) => ({
    submission_id: s.submission_id,
    student_name: s.student_name,
    strengths: ["对核心概念有一定理解", "结合了具体场景举例"],
    weaknesses: ["缺少深入分析", "部分推导跳跃"],
    dimension_scores: Object.fromEntries(
      dims.map((d) => [
        d,
        ["完整", "准确", "流畅", "一般"][Math.floor(Math.random() * 4)],
      ]),
    ),
  }));
  return {
    ...
    data: {
      ...
      teaching_suggestions: ["课堂上补充相关案例", "强调概念解释和例子结合"],
      created_at: new Date().toISOString(),
    },
    message: "analyzed",
  };
...
async function handleTeacherAnalyzeReport(
  _courseId: string,
  asgId: string,
): Promise<ApiResponse<unknown>> {
  await delay();
  return handleTeacherAnalyze(_courseId, asgId, {
