...
export async function getTeacherQuizzes(
  ...
  const res = await request.get(`/teacher/courses/${courseId}/quizzes`, { params })
...
export async function updateQuizStatus(
  ...
  const res = await request.patch(`/teacher/courses/${courseId}/quizzes/${quizId}`, { status })
...
export async function getQuizAttempts(
  ...
  const res = await request.get(`/teacher/courses/${courseId}/quizzes/${quizId}/attempts`)
...
export async function getStudentQuiz(
  ...
  const res = await request.get(`/student/courses/${courseId}/quizzes/${quizId}`)
...
export async function startQuiz(
  ...
  const res = await request.post(`/student/courses/${courseId}/quizzes/${quizId}/start`)
